...
export interface Application extends EventEmitter, IRouter, Express.Application {
     ...
     */
    listen(port: number, hostname: string, backlog: number, callback?: (any) => void): http.Server;
    listen(port: number, hostname: string, callback?: (any) => void): http.Server;
    listen(port: number, callback?: (any) => void): http.Server;
    listen(callback?: (any) => void): http.Server;
    listen(path: string, callback?: (any) => void): http.Server;
    listen(handle: any, listeningListener?: (any) => void): http.Server;
